 ...
 */
export function SectionHeading({ title, eyebrow, subtitle, align = "left", className }: SectionHeadingProps) {
  ...
  return (
    <Reveal variant="slide-up" className={className}>
      <div className={centered ? "text-center" : undefined}>
        ...
        <div className={`h-1 w-20 rounded-full bg-gradient-to-r from-primary to-accent ${centered ? "mx-auto" : ""}`} />
