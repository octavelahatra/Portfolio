  ...
  return (
    <section id="projects" className="py-20 px-6 relative">
      <div className="max-w-7xl mx-auto">
        <SectionHeading eyebrow="Portfolio" title="Mes projets" className="mb-16" />

        <StaggerGroup className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projectsData.map((project) => (
            <StaggerItem key={project.id} variant="slide-up">
              {/* data-cursor-hover: picked up by the optional global
                  CursorFollower, if/when it's mounted — see components/motion/README.md. */}
              <TiltCard className="group glowing-border overflow-hidden rounded-lg" data-cursor-hover>
