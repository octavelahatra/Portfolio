  ...
  return (
    <section id="about" className="py-20 px-6 relative">
      <div className="max-w-6xl mx-auto">
        <SectionHeading eyebrow="Qui suis-je" title="À propos de moi" className="mb-16" />

        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <Reveal variant="slide-right" className="space-y-4">
          ...
          <Reveal variant="slide-left" delay={0.1} className="glowing-border p-8">
        ...
        <div>
          ...
          <StaggerGroup className="max-w-4xl mx-auto space-y-6">
            {timelineItems.map((item, index) => (
              <StaggerItem key={index} className="glowing-border p-6 hover:scale-105 transition-transform duration-300">
